...
const Tab = ({
    ...
    return (
        <div
            ...
            className={cn(
                "flex items-center gap-2 h-8.75 pl-2 pr-1.5 cursor-pointer text-muted-foreground border-y border-x border-transparent hover:bg-accent/30",
                isActive && "bg-background text-foreground border-x-border border-b-border mb-px drop-shadow-2xl",
...
export const TopNavigationBar = ({ projectId }: { projectId: Id<"projects"> }) => {
